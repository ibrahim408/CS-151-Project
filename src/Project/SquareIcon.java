...
/**
 * Style that creates Square pits.
 * 
 * @author Team Captain 
 * Josh Gill, Ibrahim Ibrahim, Alexander Nguyen
 */
public class SquareIcon implements MancalaStone {
	Rectangle2D.Double pit;
	 ...
	 *            Height of the Icon.
	 * @param rockCount
	 *            Number of rocks in the pit.
	 */
	public SquareIcon(int width, int height, int rockCount) {
		this.width = width;
		this.height = height;
	 ...
	 * 
	 * @param c
	 *            Component that is passed for painting.
	 * @param g
	 *            Graphic to draw pits.
	 * @param x
	 *            Location to draw in x direction.
	 * @param y
	 *            Location to draw in y direction.
	 */
	 ...
	 * 
	 * @param c
	 *            passed variable of Paint Icon
	 * @param g
	 *            Graphic to fill ovals.
	 */
